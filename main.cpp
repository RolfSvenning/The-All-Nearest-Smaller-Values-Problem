...
//    printArraysVI(list<sequence<VI>>{L, R});
    ...
    long n = 4194304; // 2^24 = 16777216 2^22 = 4194304 2^20 = 1048576 2^18 = 262144 2^16 = 65536
    int rounds = 3;
    bool usingHeuristic = true;
...
//    experimentAllInputs("speedup", n, algorithmType, rounds);
    ...
    // SPEEDUP
//    experimentAllInputsAllAlgorithms("speedup", n, rounds);

    // RUNNING TIME
//    experimentRunningTime(20, 4096, 3);

    // BLOCK SIZE 64 * 64 = 4096
//    experimentBlocksize(1048576, 3);
